    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="/cuentas-por-cobrar/vencidas" class="btn btn-outline-danger">
                        <i class="ti ti-alert-circle me-1"></i>
                        Vencidas (<?= $vencidas ?>)
                    </a>
                    <a href="/cuentas-por-cobrar/por-vencer" class="btn btn-outline-warning">
                        <i class="ti ti-clock me-1"></i>
                        Por Vencer (<?= $por_vencer ?>)
                    </a>
                    <a href="/cuentas-por-cobrar/antiguedad" class="btn btn-outline-info">
                        <i class="ti ti-chart-bar me-1"></i>
                        Antigüedad de Saldos
                    </a>
                    <a href="/cuentas-por-cobrar/nuevo" class="btn btn-primary">
            ...
            <div class="card-body">
                <?php if (empty($cuentas)): ?>
                    <div class="empty">
                        ...
                        <p class="empty-title">No hay cuentas por cobrar</p>
                        <p class="empty-subtitle text-muted">
                            <?= $estado_actual === 'todos' ? 'Aún no se han registrado cuentas por cobrar' : 'No hay cuentas con estado: ' . $estado_actual ?>
                        </p>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-list flex-nowrap">
                                                <a href="/cuentas-por-cobrar/ver/<?= $cuenta['id'] ?>" class="btn btn-sm btn-icon btn-primary" title="Ver detalle">
                                                    <i class="ti ti-eye"></i>
                                                </a>
                                            </div>
                                        </td>
