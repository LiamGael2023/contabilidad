<div class="row">
    <div class="col-12">
        <h1><i class="bi bi-plus-square"></i> Registrar Compra</h1>
        <hr>
    </div>
</div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="/registro-compras/guardar">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-2">
                            ...
                            <select class="form-select" name="tipo_documento_proveedor" id="tipo_doc" required>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" name="numero_documento_proveedor" id="num_doc" required>
                        </div>
                        <div class="col-md-7">
                            <label class="form-label">Razón Social/Nombre *</label>
                            <input type="text" class="form-control" name="razon_social_proveedor" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-selectgroup">
                            <label class="form-selectgroup-item">
                                <input type="radio" name="tipo_compra" value="bien" class="form-selectgroup-input" checked>
                                <span class="form-selectgroup-label">Bienes</span>
                            </label>
                            <label class="form-selectgroup-item">
                                <input type="radio" name="tipo_compra" value="servicio" class="form-selectgroup-input">
                                <span class="form-selectgroup-label">Servicios</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="alert alert-info">
                        ...
                        El IGV registrado es crédito fiscal deducible.
                    </div>

                    <hr>

                    <div class="d-flex justify-content-between">
                        <a href="/registro-compras" class="btn btn-secondary">
