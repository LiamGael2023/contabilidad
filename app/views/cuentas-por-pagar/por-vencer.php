    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <form method="GET" action="/cuentas-por-pagar/por-vencer" class="d-inline-flex align-items-center">
                    ...
                    <a href="/cuentas-por-pagar" class="btn btn-outline-secondary btn-sm">
                            ...
                            <tbody>
                                <?php foreach ($cuentas as $cuenta): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/cuentas-por-pagar/ver/<?= $cuenta['id'] ?>" class="btn btn-sm btn-icon btn-primary">
                                                <i class="ti ti-eye"></i>
                                            </a>
                                        </td>
                                    </tr>
