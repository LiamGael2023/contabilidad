<div class="page-header d-print-none">
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                <h2 class="page-title">
                    <i class="ti ti-plus me-2"></i>Registrar Cuenta por Pagar
                </h2>
            </div>
            <div class="col-auto ms-auto d-print-none">
                <a href="/cuentas-por-pagar" class="btn btn-outline-secondary">
...
<div class="page-body">
    <div class="container-xl">
        <form method="POST" action="/cuentas-por-pagar/guardar" id="formCuentaPorPagar">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            <label class="form-label">Registro de Compra (Opcional)</label>
                            <input type="number" class="form-control" name="registro_compra_id" placeholder="ID del registro">
                            <small class="form-hint">Si proviene de un registro de compras</small>
                        </div>
                    </div>
                            ...
                            <select class="form-select" name="tercero_id" id="tercero_id" required>
                                ...
                                <?php foreach ($proveedores as $proveedor): ?>
                                    <option value="<?= $proveedor['id'] ?>"
                                            data-documento="<?= htmlspecialchars($proveedor['numero_documento']) ?>">
                                        <?= htmlspecialchars($proveedor['razon_social']) ?> - <?= htmlspecialchars($proveedor['numero_documento']) ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        </div>
            ...
            <div class="card-footer text-end mt-3">
                <div class="d-flex">
                    <a href="/cuentas-por-pagar" class="btn btn-link">Cancelar</a>
                    <button type="submit" class="btn btn-primary ms-auto">
                        <i class="ti ti-device-floppy me-1"></i>Guardar Cuenta por Pagar
                    </button>
                </div>
            </div>
        </form>
