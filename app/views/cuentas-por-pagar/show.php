<div class="page-header d-print-none">
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                <h2 class="page-title">
                    <i class="ti ti-file-invoice me-2"></i>Detalle de Cuenta por Pagar
                </h2>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <?= htmlspecialchars($cuenta['proveedor_nombre'] ?? 'N/A') ?><br>
            ...
            <div class="col-md-4">
                ...
                <div class="card mt-3">
                    <div class="card-header bg-danger-lt">
                        <h3 class="card-title text-danger">Registrar Pago</h3>
                    </div>
                    <div class="card-body">
...
document.getElementById('formRegistrarPago')?.addEventListener('submit', function(e) {
    ...
    fetch('/cuentas-por-pagar/registrar-pago', {
        method: 'POST',
        headers: {
